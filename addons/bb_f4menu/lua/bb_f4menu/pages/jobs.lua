	...
	function parent.BuildJobPanel()
	    ...
	    for _, cat in pairs(categories) do
	    	...
	    	for k, v in pairs(cat.members) do
				...
				btn_panel:SetSize(col_size()/*cfg["double_job_line"] and 200 or 250 76561198041868487*/,cfg["job_scale"] and 48 or 32);
...
function _blackberry.f4menu.pages.jobs_func.initPlayerInfoList(parent, job)
    ...
    //DarkRP.setPreferredJobModel(self.job.team, self.strModel) 76561198041868510
	--[[-------------------------------------------------------------------------
	Become
	---------------------------------------------------------------------------]]

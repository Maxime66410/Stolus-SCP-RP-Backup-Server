    ...
    for _, category in pairs(categories) do
	    ...
	    for k,v in pairs(guns) do
			...
			btn_panel.Paint = function(self, w, h)
				...
				//draw.RoundedBox(0, 58, 0, w-10-32, h, Color(0, 0, 0, 50)); 76561198041868510
				...
				draw.SimpleText(L["price"]..": "..DarkRP.formatMoney(v.pricesep or v.price), "Raleway 15", 10+32+5, 17, Color(_blackberry.f4menu.config["main_color"].r, _blackberry.f4menu.config["main_color"].g, _blackberry.f4menu.config["main_color"].b, 150), 0, 0);
				draw.SimpleText(L["price"]..": "..DarkRP.formatMoney(v.pricesep or v.price), "Raleway 15", 10+32+5, 17, Color(255, 255, 255, 255*self.lerp1), 0, 0);
			end;
			btn_panel.OnCursorEntered = function(self)
				surface.PlaySound(cfg["sound_hover"]);
				self.Active = true;
...
function _blackberry.f4menu.pages.shop_func.initAmmo(parent)
    ...
    for k,v in pairs(ammo) do
		...
		btn_panel.Paint = function(self, w, h)
			...
			draw.SimpleText(L["price"]..": "..DarkRP.formatMoney(v.price), "Raleway 15", 10+32+5, 17, Color(_blackberry.f4menu.config["main_color"].r, _blackberry.f4menu.config["main_color"].g, _blackberry.f4menu.config["main_color"].b, 150), 0, 0);
			draw.SimpleText(L["price"]..": "..DarkRP.formatMoney(v.price), "Raleway 15", 10+32+5, 17, Color(255, 255, 255, 255*self.lerp1), 0, 0);
		end;
		btn_panel.OnCursorEntered = function(self)
			surface.PlaySound(cfg["sound_hover"]);
			self.Active = true;
